export const MODBOOK_PRESETS = [
  {
    ...
    slots: {
      outer: {
        label: '겉옷',
        image: '/assets/modbook-presets/outer-team.webp',
        mods: [
          { type: '접두', name: '기운찬' },
          { type: '접미', name: '바람의' },
        ],
      ...
      top: {
        label: '상의',
        image: '/assets/modbook-presets/top-team.webp',
        mods: [
          { type: '접미', name: '전력질주의' },
        ],
      ...
      bottom: {
        label: '하의',
        image: '/assets/modbook-presets/bottom-team.webp',
        mods: [
          { type: '접두', name: '잡기 힘든' },
          { type: '접미', name: '쾌속의' },
        ],
      ...
      shoes: {
        label: '신발',
        image: '/assets/modbook-presets/shoes-team.webp',
        mods: [
          { type: '접두', name: '기운찬' },
          { type: '접미', name: '레이서의' },
        ],
